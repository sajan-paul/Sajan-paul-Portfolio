...
const textArray = ["UI/UX Designer", "Web Developer", "Web Designer", "Designer"];
let textIndex = 0;
...
changeText(); // Call immediately on page load
...
document.addEventListener("DOMContentLoaded", function () {
  const aboutMeButton = document.querySelector('[data-nav-link]');
  if (aboutMeButton) {
      aboutMeButton.click(); // Simulate a click to open "About Me"
  }
}); 
